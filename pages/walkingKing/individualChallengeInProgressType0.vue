  ...
  >
    ...
    <StickyProfileSection>
      ...
      <FlexRowDiv class="gap-8 mt-18 mb-32">
        <ChallengeStepsBox title="건강걸음" steps="-" />
        <ChallengeStepsBox title="플러스걸음" steps="-" />
        <ChallengeStepsBox title="총 걸음" steps="-" type="total" @click="clickStepHistoryModal" />
      </FlexRowDiv>
    </StickyProfileSection>
    <!-- TOP30 / MY랭킹 / 친구 탭 -->
    <RoundTabs :tabs="roundTabs" :active-key="activeRoundTab" @tab-change="onRoundTabChange" />
    <ChallengeNoResultBox
      :tit="'현재 랭킹 집계 중입니다.<br/> 잠시 후 첫 랭킹이 공개됩니다.'"
      :text="'참가자들의 걸음수를 모으고 있어요.<br/>걷기왕 대회의  랭킹 갱신은 5분 단위로 진행되며<br/>첫 랭킹은 대회 시작 5분 후 공개됩니다.<br/>조금만 기다려주세요.'"
      class="mt-16"
    />
