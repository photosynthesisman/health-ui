<template>
  ...
  >
    <h1 class="c-tit mt-24">
      <span class="text">
        청구의신 대리청구 서비스<br />이용을 위해 동의해 주세요
      </span>
    </h1>
    <div class="wrap-agree-check">
      ...
      <ul class="agree-list">
        <li class="item" @click="showDetailTerm">
          <Checkbox id="checkBox2" v-model="checkbox2" custom-style="small non-border" aria-label="개인(신용)정보 수집·이용 동의" />
          <i class="icon-arrow-right"></i>
        </li>
        <li class="item" @click="showDetailTerm">
          <Checkbox id="checkBox3" v-model="checkbox3" custom-style="small non-border" aria-label="고유식별정보 처리 동의" />
          <i class="icon-arrow-right"></i>
        </li>
        <li class="item" @click="showDetailTerm">
          <Checkbox id="checkBox4" v-model="checkbox4" custom-style="small non-border" aria-label="보험금청구를 위한 진료정보 처리 동의" />
          <i class="icon-arrow-right"></i>
        </li>
        <li class="item" @click="showDetailTerm">
          <Checkbox id="checkBox5" v-model="checkbox5" custom-style="small non-border" aria-label="진료정보 처리 동의" />
          <i class="icon-arrow-right"></i>
        </li>
      </ul>
    </div>
  ...
  <ButtonGroup class="is-fixed">
    <Button btn-type="primary" element-type="button" aria-label="동의하고 다음" class="lg w-full medium btn-sticky" @click="clickBottomModal" />
  </ButtonGroup>
  <BottomModal
    title="사용할 본인 서명 입력"
