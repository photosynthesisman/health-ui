<template>
  ...
  >
    <div class="flex flex-col gap-16 mt-24">
      <h1 class="c-tit">
        <span class="text">사고(상해)가 일어난<br />주소를 입력해 주세요</span>
      </h1>
    </div>
    <div class="flex flex-col gap-12 mt-32">
      <InputAddress label="주소" :is-valid="false" class="require" placeholder="주소를 검색하세요" />
      <div class="wrap-signature">
        <div class="input-tit required">사고(내원) 내용</div>
        <InputText placeholder="(예) 감기몸살, 장염, 골절" />
      </div>
      <InputCalendar label="사고(진료) 일자 *" />
      <Select
        label="사고 유형"
        class="require"
        modal-title="사고 유형"
