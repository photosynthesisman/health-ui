      ...
      .select-item {
        ...
        &.arrow-down {
          &:after {
            ...
            background-position: center;
            background-image: url("data:image/svg+xml,%0A%3Csvg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M18.3332 5.41797L11.6665 5.41797' stroke='%232F3034' stroke-width='1.5' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M4.99984 5.41797H1.6665' stroke='%232F3034' stroke-width='1.5' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M8.33317 8.33333C9.944 8.33333 11.2498 7.0275 11.2498 5.41667C11.2498 3.80584 9.944 2.5 8.33317 2.5C6.72234 2.5 5.4165 3.80584 5.4165 5.41667C5.4165 7.0275 6.72234 8.33333 8.33317 8.33333Z' stroke='%232F3034' stroke-width='1.5' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M18.3333 14.582H15' stroke='%232F3034' stroke-width='1.5' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M8.33317 14.582H1.6665' stroke='%232F3034' stroke-width='1.5' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='M11.6667 17.5013C13.2775 17.5013 14.5833 16.1955 14.5833 14.5846C14.5833 12.9738 13.2775 11.668 11.6667 11.668C10.0558 11.668 8.75 12.9738 8.75 14.5846C8.75 16.1955 10.0558 17.5013 11.6667 17.5013Z' stroke='%232F3034' stroke-width='1.5' stroke-miterlimit='10' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E%0A");
          }
        }
      }
    }
