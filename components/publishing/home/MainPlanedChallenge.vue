    ...
    <template #default="{ slide, index }">
      <div class="main-challenge-card">
        <div class="challenge-date-limit">
          <strong class="limit-date">D-{{ slide.daysLeft }}</strong>
          <span>모집중</span>
        </div>
...
const props = withDefaults(defineProps<Props>(), {
  slides: () => [
    ...
    },
    {
      id: 2,
      category: '걸어서 회사까지',
      title: '출퇴근 러닝 챌린지<br /> 출퇴근 러닝 챌린지',
      schedule: '2025. 06. 15 ~ 2025. 06. 30',
      buttonText: '챌린지 참가참가',
      buttonLink: 'javascript:void(0)',
    ...
    {
      id: 3,
      category: '걸어서 회사까지 걸어서 회사까지',
      title: '출퇴근 러닝 챌린지 12345',
      schedule: '2025. 06. 15 ~ 2025. 06. 30',
      buttonText: '참가참가 챌린지',
      buttonLink: 'javascript:void(0)',
