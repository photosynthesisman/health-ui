<template>
  <div class="profile-box">
    ...
    <button v-if="isTalking" type="button" class="btn talking-btn" @click="handleTalkClick">대화하기</button>
    <template v-else>
...
const emit = defineEmits(['talk-click'])

const handleTalkClick = () => {
  emit('talk-click', { id: props.id, name: props.name }) // 필요한 데이터를 함께 전달
}
